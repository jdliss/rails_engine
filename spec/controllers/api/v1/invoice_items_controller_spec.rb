...
RSpec.describe Api::V1::InvoiceItemsController do
  ...
  describe "index" do
    it "responds with an index of invoice items" do
      ...
      expect(first_invoice_item[:unit_price]).to eq 100
      ...
      expect(second_invoice_item[:unit_price]).to eq 99
  ...
  describe "show" do
    it "responds with the requested invoice item" do
      ...
      expect(invoice_items_hash[:unit_price]).to eq 100
  ...
  describe "find_all" do
    it "responds with all invoice items matching passed id" do
      ...
      expect(invoice_items_hash.first[:unit_price]).to eq 100
